        ...
        <div class="app">
            ...
            <a href="#">Privacy policy</a></li> 
             ...
             <ul>
              ...
              </li> <li><i class="bx bx-chevron-right">
              </i> <a href="#">Product Management</a>
              </li> 
              <li><i class="bx bx-chevron-right"></i> 
              <a href="#">Marketing</a>
              </li> 
              ...
              <div class="col-lg-3 col-md-6 footer-contact"> <h4>Contact Us</h4> 
              ...
              <div class="col-lg-3 col-md-6 footer-info"> <h3>About dmart</h3> <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In deleniti dolorum consequuntur officiis et maiores tempora amet minima excepturi voluptates nemo ipsa mollitia, fugit soluta provident pariatur quidem dicta quibusdam possimus cumque, eum enim reprehenderit. Necessitatibus iste, eum deserunt hic veniam rem, et minus dignissimos provident, vitae ducimus harum vel?</p> <div class="social-links mt-3"> <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a> <a href="#" class="facebook"><i class="bx bxl-facebook"></i></a> <a href="#" class="instagram"><i class="bx bxl-instagram"></i></a> <a href="#" class="linkedin"><i class="bx bxl-linkedin"></i></a> </div> </div> </div> </div> </div> <div class="container"> <div class="copyright"> &copy; Copyright <strong><span>dmart</span></strong>. All Rights Reserved </div> <div class="credits"> Designed by <a href="#">dmart</a> </div> </div>
    </footer>
  </div>
  <!-- End Back to top -->
</footer>
